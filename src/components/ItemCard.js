// Items modify the stats of the rider holding it

// Rain jacket - The user is immune to rainy condition effects
// Energy bar - is consumed when the rider fails an energy check and allows the rider to reroll the results
// Water bottle - 
// 
...
const RiderCard = ({rider}) => {
  return (
    <>
        <div key={rider.id} style={ItemCardStyle}>
            <div style={ItemImageStyle}>{rider.image}</div>
            <div style={ItemNameStyle}>{rider.name}</div>
            <div style={ItemModifiers}>
